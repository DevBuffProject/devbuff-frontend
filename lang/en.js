...
export default {
    ...
    skillEditor: {
      header: {
        ...
        specializationsSlide: {
          specialization:
            'In what specialisation did you work for this language: ',
        },
        technologiesSlide: {
  ...
  page: {
    index: {
      ...
      description:
        'это площадка для разработчиков, которые хотят привлечь единомышленников для совместной реализации своих идей',
      oAuth: {
