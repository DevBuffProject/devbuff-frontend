...
export default {
  ...
  components: {
    ...
    skillEditor: {
      header: {
        languagesSlide: {
          language: 'Select the languages you worked with',
          specialization: 'Specializations',
        },
        specializationsSlide: {
          specialization: 'What direction did you work on languages: ',
        },
        technologiesSlide: {
          technology: 'Technologies for language %s in specialization %s'
        },
      },
      controls: {
        back: 'Back'
  ...
  page: {
    ...
    ideas: {
      explore: {
        ...
        filter: {
          sortType: {
            lastPublishDate: 'By publication date',
