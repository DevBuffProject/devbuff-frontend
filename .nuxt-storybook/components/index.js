export { default as VApp } from '../../components/App.vue'
export { default as VAnim } from '../../components/Anim/Anim.vue'
export { default as VAvatar } from '../../components/Avatar/Avatar.vue'
export { default as VButton } from '../../components/Button/Button.vue'
export { default as VCard } from '../../components/Card/Card.vue'
export { default as VChip } from '../../components/Chip/Chip.vue'
export { default as VDelimiter } from '../../components/Delimiter/Delimiter.vue'
export { default as VDialog } from '../../components/Dialog/Dialog.vue'
export { default as VEventBus } from '../../components/Dialog/EventBus.js'
export { default as VSimpleDialog } from '../../components/Dialog/SimpleDialog.vue'
export { default as VWindowAbstract } from '../../components/Dialog/WindowAbstract.js'
export { default as VD2 } from '../../components/Dialog/d2.vue'
...
export const LazyVApp = import('../../components/App.vue' /* webpackChunkName: "components/App" */).then(c => c.default || c)
export const LazyVAnim = import('../../components/Anim/Anim.vue' /* webpackChunkName: "components/Anim/Anim" */).then(c => c.default || c)
export const LazyVAvatar = import('../../components/Avatar/Avatar.vue' /* webpackChunkName: "components/Avatar/Avatar" */).then(c => c.default || c)
export const LazyVButton = import('../../components/Button/Button.vue' /* webpackChunkName: "components/Button/Button" */).then(c => c.default || c)
export const LazyVCard = import('../../components/Card/Card.vue' /* webpackChunkName: "components/Card/Card" */).then(c => c.default || c)
export const LazyVChip = import('../../components/Chip/Chip.vue' /* webpackChunkName: "components/Chip/Chip" */).then(c => c.default || c)
export const LazyVDelimiter = import('../../components/Delimiter/Delimiter.vue' /* webpackChunkName: "components/Delimiter/Delimiter" */).then(c => c.default || c)
export const LazyVDialog = import('../../components/Dialog/Dialog.vue' /* webpackChunkName: "components/Dialog/Dialog" */).then(c => c.default || c)
export const LazyVEventBus = import('../../components/Dialog/EventBus.js' /* webpackChunkName: "components/Dialog/EventBus" */).then(c => c.default || c)
export const LazyVSimpleDialog = import('../../components/Dialog/SimpleDialog.vue' /* webpackChunkName: "components/Dialog/SimpleDialog" */).then(c => c.default || c)
export const LazyVWindowAbstract = import('../../components/Dialog/WindowAbstract.js' /* webpackChunkName: "components/Dialog/WindowAbstract" */).then(c => c.default || c)
export const LazyVD2 = import('../../components/Dialog/d2.vue' /* webpackChunkName: "components/Dialog/d2" */).then(c => c.default || c)
